...
if __name__ == '__main__':
    train_answer_file = 'data/mscoco_train2014_annotations_convert_2.json'
    train_answers = json.load(open(train_answer_file))['annotations']

    val_answer_file = 'data/mscoco_val2014_annotations_convert_2.json'
    val_answers = json.load(open(val_answer_file))['annotations']

    train_question_file = 'data/OpenEnded_mscoco_train2014_questions.json'
    train_questions = json.load(open(train_question_file))['questions']

    val_question_file = 'data/OpenEnded_mscoco_val2014_questions.json'
